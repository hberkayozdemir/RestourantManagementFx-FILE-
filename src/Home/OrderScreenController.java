...
/*
   double a = eco.getPrice();
  if(a == 0)
   {
       eco.setPrice(9.0);
   }
   else{
       eco.setPrice(eco.getPrice()+9.0);
   }
...
/*
    if(eco.getPrice()==0){
        ...
        eco.setPrice(eco.getPrice()+10.0);
    }
...
/*
    if(eco.getPrice()==0){
        ...
        eco.setPrice(eco.getPrice()+12.0);
    }
